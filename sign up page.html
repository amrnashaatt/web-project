  ...
  <header class="mb-auto">
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
        ...
        <a class="nav-link fw-bold py-1 px-0" href="Donate page.html">Donate</a>
...
<script>
    // Function to show the thank you banner
    function showThankYouBanner() {
        // Create a new div element for the banner
        var bannerDiv = document.createElement("div");
        bannerDiv.className = "alert alert-success mt-3";
        bannerDiv.setAttribute("role", "alert");
        bannerDiv.textContent = "Thank you for registerting! We appreciate your support, we will reach you as soon as possible.";

        // Insert the banner after the form
        var form = document.querySelector("main form");
        form.parentNode.insertBefore(bannerDiv, form.nextSibling);
    }
