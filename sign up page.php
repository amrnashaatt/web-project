...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="form-signin w-100 m-auto">
    <form onsubmit="handleFormSubmission(event);">
        <h1 class="h3 mb-3 fw-normal">Please sign up as a volunteer below</h1>
...
<script>
    ...
    function showThankYouBanner() {
        ...
        bannerDiv.textContent = "Thank you for signing up!</strong> We appreciate your support, we will reach you as soon as possible.";
...
function handleFormSubmission(event) {
    ...
    var fullName = document.getElementById("floatingFullName").value.trim();
